...
sequelize.sync();
WorkflowInstanceLog.belongsTo(Programs, {
    foreignKey: "program_id",
    as: "programs",
});
WorkflowInstanceLog.belongsTo(Module, {
    foreignKey: "module",
    as: "Module",
});
WorkflowInstanceLog.belongsTo(Event, {
    foreignKey: "event_id",
    as: "event",
});
WorkflowInstanceLog.belongsTo(WorkflowMethod, {
    foreignKey: "method_id",
    as: "method",
});
WorkflowInstanceLog.belongsTo(Workflow, {
